...
TOOLS_BLOCK = (
    ...
    "picture again only when you must see it. The `research` tool searches the open "
    "web for what you do not hold: a recipe, a price, an opening time, anything that "
    ...
    "read: a link the person sent you, or a source from earlier research. A URL you "
